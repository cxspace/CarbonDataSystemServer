...
<div class="container">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <form action="${pageContext.request.contextPath}/sys/story_edit.do" method="post">


                <input type="hidden" name="id" value="${story.id}">
                <input type="hidden" name="iconsrc" value="${story.iconsrc}">
                <input type="hidden" name="create_time" value="${story.create_time}">
                <input type="hidden" name="imgsrc" value="${story.imgsrc}">

                <div class="form-group">
                    <label for="title"></label>
                    <input type="text" class="form-control" id="title" name="title" value="${story.title}" placeholder="标题">
                </div>
                <div class="form-group">
                    <label for="content">内容</label>


                    <textarea class="form-control" rows="3" id="content" name="content" placeholder="内容">${story.content}</textarea>
