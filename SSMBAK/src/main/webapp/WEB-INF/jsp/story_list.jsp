...
<div class="container">
    ...
    <div class="panel panel-default">
        ...
        <table class="table table-hover">
            ...
            <tbody>
               ...
               <c:forEach items="${storyList}" var="items">
               ...
               <tr>
                   ...
                   <td>
                       <a class="btn btn-default btn-sm" href="${pageContext.request.contextPath}/sys/story_editUI.do?storyId=${items.id}" role="button">修改</a>

                       &nbsp;&nbsp;&nbsp;&nbsp;

                       <a class="btn btn-danger btn-sm" href="${pageContext.request.contextPath}/sys/story_delete.do?storyId=${items.id}" role="button">删除</a>
                   </td>
               </tr>
               </c:forEach>
    ...
    <div class="row">
        ...
        <center>
        <a href="${pageContext.request.contextPath}/sys/story_addUI.do" class="btn btn-default btn-lg">添加新故事</a>
        </center>
